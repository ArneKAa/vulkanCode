...
private:
    ...
    bool collisionCheck(float x1, float y1,float z1, float oScale1, float x2, float y2, float z2, float oScale2);
    bool triggerCheck(float x1, float y1, float oScale1, float x2, float y2, float oScale2);
    void teleport(int index);
    bool isDead = false;
    bool isDeadWritten = false;
    int totalPickups = 7;
    int pickedUpPickups = 0;
